...
quantidade_pizzas_vendidas= int(input("Quantas pizzas ja vendidas? "))
...
meta_financeira_liquida= float(input("Qual a meta lucro desejada?"))
if liquido<=0:
    print("In erro: valor do preço errado")
    ...
    if lucro_faltante<=0:
        ...
        print(f"Voce precisar vender {pizzas_necessarias}pizzas")
